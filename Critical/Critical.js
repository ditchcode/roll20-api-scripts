...
var Critical = (function()
{
	...
	const criticalHit =
	[
		{low: 1,  high: 25,  result: "Hard Hit", slash: "2x Damage.", blunt: "2x Damage.", pierce: "2x Damage"},
		{low: 26,  high: 30,  result: "Hard Hit", slash: "2x Damage.", blunt: "2x Damage.", pierce: "2x Damage", extra: "Wakka, wakka! I'm from palatka!"},
		...
		{low: 41, high: 57,  result: "Massive Hit", slash: "3x Damage.", blunt: "3x Damage.", pierce: "3x Damage."},
		{low: 57, high: 57,  result: "Massive Hit", slash: "3x Damage.", blunt: "3x Damage.", pierce: "3x Damage.", extra: "20% primary weapon ripped away 10 feet random direction"},
		{low: 58, high: 58,  result: "Massive Hit", slash: "3x Damage.", blunt: "3x Damage.", pierce: "3x Damage.", extra: "20% secondary weapon or shield ripped away 10 feet random direction"},
		{low: 59, high: 59,  result: "Massive Hit", slash: "3x Damage.", blunt: "3x Damage.", pierce: "3x Damage.", extra: "20% Chance random equipment ripped off you landing 10 feet random direction"},
		{low: 60, high: 60,  result: "Massive Hit", slash: "3x Damage.", blunt: "3x Damage.", pierce: "3x Damage.", extra: "20% Chance random bag, pouch, or sack ripped open spilling contents"},
		{low: 61, high: 61,  result: "Staggering Blow", slash: "3x Damage.", blunt: "3x Damage.", pierce: "3x Damage.", extra: "Armor piece knocked off, strap cut, belt cut, clothes torn/twisted, lose 2 AC until fixed."},
		{low: 62, high: 62,  result: "Staggering Blow", slash: "3x Damage.", blunt: "3x Damage.", pierce: "3x Damage.", extra: "Zero movement until end of round"},
		{low: 63, high: 63,  result: "Staggering Blow", slash: "3x Damage.", blunt: "3x Damage.", pierce: "3x Damage.", extra: "Stagger into any fire within 5 feet, you are caught ablaze."},
		{low: 64, high: 64,  result: "Staggering Blow", slash: "3x Damage.", blunt: "3x Damage.", pierce: "3x Damage.", extra: "Blurred vision, all rolls at disadvantage until end of next round"},
		{low: 65, high: 65,  result: "Staggering Blow", slash: "3x Damage.", blunt: "3x Damage.", pierce: "3x Damage.", extra: "Staggered 10 feet in random direction and left prone"},
		{low: 66, high: 67,  result: "Eviscerating Hit", slash: "3x Damage. 55% chance shield breaks", blunt: "3x Damage. 55% chance shield breaks", pierce: "3x Damage. Roll DEX or be knocked down.", extra: "Rock the Casbah!"},
		{low: 68, high: 68,  result: "Eviscerating Hit", slash: "3x Damage.", blunt: "3x Damage.", pierce: "3x Damage.", extra: "Spitting up blood, no verbal casting for rest of round"},
		{low: 69, high: 69,  result: "Eviscerating Hit", slash: "3x Damage.", blunt: "3x Damage.", pierce: "3x Damage.", extra: "Massive bleeding/hemmorrhaging. Extra 1d4 damage for 1d4 rounds."},
		...
		{low: 71, high: 71,  result: "Hand", slash: "Lose 1 finger, -1 to hit and damage. Was it a ring finger?", blunt: "1d4 fingers broken, -1 to hit and damage.", pierce: "Punctured muscle, -1 to hit and damage."},
		{low: 72, high: 72,  result: "Hand", slash: "Lose 1d4 fingers, -2 to hit and damage. Good-bye magic ring?", blunt: "hand broken, -2 to hit and damage.", pierce: "Punctured hand incapacitated, -2 to hit and damage."},
		...
		{low: 99, high: 99,  result: "Head", slash: "Nose removed, 1d4 teeth lost.", blunt: "Nose crushed, 1d4 teeth crushed.", pierce: "Skull pierced, dead.", extra: "That's going to leave a scar."},
		{low: 100, high: 100,  result: "Head", slash: "Decapitated, dead.", blunt: "Skull crushed, dead.", pierce: "Skull pierced, dead.", extra: "Ooo-raaa!"}
	];
		...
		if (msg.type === "api" && msg.content.indexOf("!critical") !== -1)
		{
			...
			if (words.length > 0)
			{
				...
				if (words[0] === '!critical')
				{
					...
					if (smash)
					{
					    let msg = rolled.toString() + "% <b>" + smash.result + "</b><br><i><b>Slash: </b>" + smash.slash + '</i><br><i><b>Blunt: </b>' + smash.blunt + '</i><br><i><b>Pierce: </b>' + smash.pierce + '</i>';
					    if(smash.extra){
					        msg = msg + "<br>" + smash.extra;
					    }
						// Send the critical result as a formatted string in chat
						sendChat('Critical Hit', msg);
					}
					else
					{
